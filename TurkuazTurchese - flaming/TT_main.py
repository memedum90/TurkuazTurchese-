...
# 					twn = 1
	...
	# 							g.write("-"+x['user_id'])
				#	flamesU.append(passedU)
					...
					for tw in passed:
						f.write(tw['username']+" ==> "+tw['text'].encode('utf-8')+"\n	"+"		<vulgarity: "+str(tw['rawvulgarity'])+"/"+str(tw['vulgarity'])+"; marks: "+str(tw['marks'])+"; uppercases: "+str(tw['uppercases'])+"; smileys: "+str(tw['good'])+"; disagreement: "+str(tw['disagreement'])+"; pplxity: "+str(tw['fl_corpus'])+">\n")
